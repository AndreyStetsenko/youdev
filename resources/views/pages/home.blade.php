        ...
        'hasOfferCatalog' => [
            ...
            'itemListElement' => [
                ...
                [
                    ...
                    'itemOffered' => [
                        '@type' => 'Service',
                        'name' => __('app.mobile_development'),
                        'description' => __('app.mobile_development_desc')
                    ]
                ]
            ]
        ]
    ...
    <section class="bg-white py-24 lg:py-32">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                {{-- Mobile Development --}}
                <div class="group relative bg-white border border-trust-200 rounded-2xl p-8 hover:shadow-xl hover:border-trust-300 transition-all duration-300">
                    <div class="absolute inset-0 bg-gradient-to-br from-indigo-50 to-indigo-100 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity"></div>
                    <div class="relative">
                        <div class="w-16 h-16 bg-indigo-100 rounded-xl flex items-center justify-center mb-6 group-hover:bg-indigo-200 transition-colors shadow-sm">
                            <svg class="w-8 h-8 text-indigo-600" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
                            </svg>
                        </div>
                        <h3 class="text-2xl font-bold text-navy-900 mb-4">
                        ...
                        <p class="text-navy-700 mb-6 leading-relaxed">
                            {{ __('app.mobile_development_desc') }}
                        </p>
                        <ul class="space-y-2 mb-6">
                            <li class="flex items-center text-navy-600">
                                ...
                                {{ __('app.native_apps_feature') }}
                            </li>
                            <li class="flex items-center text-navy-600">
                                <svg class="w-4 h-4 text-indigo-600 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/>
                                </svg>
                                {{ __('app.cross_platform_feature') }}
                            </li>
                            <li class="flex items-center text-navy-600">
                                <svg class="w-4 h-4 text-indigo-600 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/>
                                </svg>
                                {{ __('app.app_store_feature') }}
                            </li>
                        </ul>
                    </div>
                </div>
