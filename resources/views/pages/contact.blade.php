<x-layouts.app>
    ...
    <section class="bg-navy-950 pt-24 pb-20 relative overflow-hidden">
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            <p class="section-label text-trust-400 mb-4">{{ __('app.contact') }}</p>
    ...
    <section class="bg-navy-50 py-16 lg:py-24">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
                {{-- Contact Form --}}
                <div class="bg-white rounded-2xl p-8 shadow-xl border border-navy-100">
                    @if(session('success'))
                    ...
                    <form method="POST" action="{{ route('contact.store', ['locale' => app()->getLocale()]) }}" 
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            <div>
                                ...
                                <input type="text" name="name" id="name" required
                                       value="{{ old('name') }}"
                                       class="w-full px-4 py-3 border border-navy-200 rounded-xl focus:ring-2 focus:ring-trust-500 focus:border-trust-500 @error('name') border-red-500 @enderror">
                                @error('name')
                            ...
                            <div>
                                ...
                                <input type="email" name="email" id="email" required
                                       value="{{ old('email') }}"
                                       class="w-full px-4 py-3 border border-navy-200 rounded-xl focus:ring-2 focus:ring-trust-500 focus:border-trust-500 @error('email') border-red-500 @enderror">
                                @error('email')
                                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            <div>
                                ...
                                <input type="tel" name="phone" id="phone"
                                       value="{{ old('phone') }}"
                                       class="w-full px-4 py-3 border border-navy-200 rounded-xl focus:ring-2 focus:ring-trust-500 focus:border-trust-500 @error('phone') border-red-500 @enderror">
                                @error('phone')
                                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="company" id="company"
                                       value="{{ old('company') }}"
                                       class="w-full px-4 py-3 border border-navy-200 rounded-xl focus:ring-2 focus:ring-trust-500 focus:border-trust-500 @error('company') border-red-500 @enderror">
                                @error('company')
                                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            <div>
                                <label for="project_type" class="block text-sm font-medium text-navy-700 mb-2">
                                    {{ __('app.project_type') }} *
                                </label>
                                <select name="project_type" id="project_type" required
                                        class="w-full px-4 py-3 border border-navy-200 rounded-xl focus:ring-2 focus:ring-trust-500 focus:border-trust-500 @error('project_type') border-red-500 @enderror">
                            ...
                            <div>
                                <label for="budget_range" class="block text-sm font-medium text-navy-700 mb-2">
                                    {{ __('app.budget_range') }} *
                                </label>
                                <select name="budget_range" id="budget_range" required
                                        class="w-full px-4 py-3 border border-navy-200 rounded-xl focus:ring-2 focus:ring-trust-500 focus:border-trust-500 @error('budget_range') border-red-500 @enderror">
                        ...
                        <div class="mb-6">
                            <label for="message" class="block text-sm font-medium text-navy-700 mb-2">
                                {{ __('app.message') }} *
                            </label>
                            <textarea name="message" id="message" rows="6" required
                                      class="w-full px-4 py-3 border border-navy-200 rounded-xl focus:ring-2 focus:ring-trust-500 focus:border-trust-500 @error('message') border-red-500 @enderror">{{ old('message') }}</textarea>
                            @error('message')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <button type="submit"
                                class="w-full bg-trust-600 hover:bg-trust-700 text-white py-4 px-6 rounded-xl font-semibold transition-colors shadow-lg shadow-trust-500/20"
                                :disabled="loading"
                ...
                <div class="space-y-8">
                    <div class="bg-white rounded-2xl p-8 shadow-xl border border-navy-100">
                        <h3 class="text-2xl font-bold text-navy-900 mb-6">{{ __('app.contact_info') }}</h3>
                        <div class="space-y-6">
                            <div class="flex items-start">
                                <div class="flex-shrink-0">
                                    <div class="w-10 h-10 bg-trust-100 rounded-xl flex items-center justify-center">
                                ...
                                <div class="ml-4">
                                    <h4 class="text-lg font-semibold text-navy-900">Email</h4>
                                    <p class="text-navy-600">andrey@stetsenko.org</p>
                                </div>
                            </div>
                            <div class="flex items-start">
                                <div class="flex-shrink-0">
                                ...
                                <div class="ml-4">
                                    <h4 class="text-lg font-semibold text-navy-900">Phone</h4>
                                    <p class="text-navy-600">+380 (67) 100-16-64</p>
                                </div>
                            </div>
                            <div class="flex items-start">
                                <div class="flex-shrink-0">
                    ...
                    {{-- Response Time --}}
                    <div class="bg-navy-900 rounded-2xl p-8 border border-navy-700">
                        <h3 class="text-xl font-bold text-white mb-4">Quick Response</h3>
                        <p class="text-navy-300 mb-4">
                            We typically respond to all inquiries within 24 hours. For urgent matters, please call us directly.
                        </p>
                        <div class="flex items-center text-trust-400">
                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/>
                            </svg>
                            <span class="font-semibold">Response time: &lt; 24 hours</span>
                        </div>
                    </div>
                </div>
            </div>
